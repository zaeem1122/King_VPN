...
import '../modals/dnsConfig.dart';
import '../modals/vpnConfig.dart';
import '../modals/vpnStatus.dart';
...
class NVPN {
  ...
  ///Get latest stage
  static Future<String> stage() => MethodChannel(_methodChannelVpnControl)
      .invokeMethod("stage")
  ...
  static Future sendToBackground() =>
      MethodChannel(_methodChannelVpnControl).invokeMethod("sendToBackground");
